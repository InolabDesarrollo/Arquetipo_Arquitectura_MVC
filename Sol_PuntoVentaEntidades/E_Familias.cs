...
{
    public class E_Familias //mismo nombre que la Tabla de la BBD
    {
        ...
        public int Codigo_fa { get; set; } // get para controlar los datos y set para cargarlos
        public string Descripcion_fa { get; set; } //fa es la misma esctructura que tiene en la BBD
