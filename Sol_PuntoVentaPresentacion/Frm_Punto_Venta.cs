...
namespace Sol_PuntoVentaPresentacion
{
    public partial class Frm_Punto_Venta : Form
    {
        ...
        private void Formato_pv()
        {
            ...
            Dgv_Listado.Columns[0].HeaderText= "CODIGO_PV"; //Texto en titulo
            Dgv_Listado.Columns[1].Width = 400; // ancho para el contenido
            Dgv_Listado.Columns[1].HeaderText = "PUNTO DE VENTA"; //Texto en titulo
        }
        ...
        private void Listado_pv(string cTexto)
        {
            try
            {
                ...
                Dgv_Listado.DataSource=N_Punto_Venta.Listado_pv(cTexto); //Metodo Listado_pv esta en capa conexion y regresa una tabla creada con un store procedure
                this.Formato_pv(); //Activara el proceso de formato
       ...
       public void Seleccion_item(){
        ...
        private void Frm_Punto_Venta_Load(object sender, EventArgs e)
        {
            ...
            this.Listado_pv("%"); //Activo el metodo, el porcentaje es para que liste todos los registros que tenga
        }
        ...
        private void BtnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (Dgv_Listado.Rows.Count > 0)
            {
                ...
                if(Opcion==DialogResult.Yes)
                {
                    ...
                    if (Rpta.Equals("OK"))
                    {
                        this.Listado_pv("%"); //Actualizamos la informacion 
        ...
        private void BtnReporte_Click(object sender, EventArgs e)
        {
            ...
            if (Dgv_Listado.Rows.Count >0)
            {
               ...
               oRpt_pv.Txtp1.Text = Textbox_buscar.Text.Trim();

             //si el formulario esta filtrado, el reporte tendra lo mismo
               oRpt_pv.ShowDialog(); //Activo la visibilidad del reporte
            }
        } 
        ...
        private void Btn_guardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    oPropiedad.Descripcion_pv=Txt_descripcion.Text.Trim(); //Trim es para mandarlo sin espacios de izquierda ni derecha


                    Rpta =N_Punto_Venta.Guardar_pv(this.Estadoguarda, oPropiedad); //Se le pasa al metodo si es registro nuevo 
        ...
        private void Btn_buscar_Click(object sender, EventArgs e)
        {
            ...
            this.Listado_pv(Textbox_buscar.Text.Trim()); //Traremos el texto del textbox sin espacios
        }
