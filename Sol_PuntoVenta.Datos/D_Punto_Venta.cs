...
namespace Sol_PuntoVenta.Datos
{
    ...
    public class D_Punto_Venta
    {
        ...
        public DataTable Listado_pv(string cTexto) //agragas parametros para que no sea algo estatico y puedas hacer filtrado de datos
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("USP_listado_pv", sqlCon); //Esta linea define la forma en que solicitaremos informacion 
        ...
        public string Guardar_pv(int nOpcion, E_Punto_Venta oPropiedad) //el parametro nOpcion es para saber si se guarda un nuevo registro o se actualiza otro; oPropiedad referencia a get y ser de E_Punto_Venta que esta en la entidad
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("USP_Guardar_pv", SqlCon); //  SqlCon es la conectividad
        ...
        public string Eliminar_pv(int nCodigo)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("USP_Eliminar_Pv",SqlCon); //el segundo parametro es la conexion 
                Comando.CommandType =CommandType.StoredProcedure;
